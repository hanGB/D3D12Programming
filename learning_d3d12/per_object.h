...
public:
	...
	template<class T>
	T* GetComponentWithType(PERComponent* sameCategoryComponent);
	...
	XMFLOAT3 GetLocalAsixForce() const;
	XMFLOAT3 GetWorldAsixForce() const;
	XMFLOAT3 GetRotateForce() const;
