...
land_and_waves::LandAndWavesFrameResource::LandAndWavesFrameResource(ID3D12Device* device, UINT passCount, UINT objectCount, UINT materialCount, UINT wavesVertexCount)
{
